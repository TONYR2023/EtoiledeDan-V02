...
const Prereserv = () => {
    ...
    const [disabledOptionsAssurances, setDisabledOptionsAssurances] = useState(true)
    ...
    async function checkForm(e)
    {
        ...
        await fetch('/email', {
            ...
            if (response.status === 200) {
                ...
                setLoaded(false)
                setMessageGeneral(
                    "Problème de serveur " + response.status
                )
            }
        }).catch((e) => {
            setLoaded(false)
                ...
                <div className="col-lg-4 mb-3">
                    ...
                    <div className="calendarContainer">
                        <Calendar
                            ...
                            range={true}
                        />
                        <input type="hidden" name="selectedDates" value={selectedDates.toString()}/>
                    </div>

                    {messageCalendar.length > 0 &&
                        <div className="p-3 mb-3 mt-3 text-bg-danger rounded-3">{messageCalendar}</div>
                    }

                    {/*------button reinitialisation calendrier-------*/}
                    <div className="d-flex justify-content-center">
                        <button type="button" onClick={handleReset} className="but-reset btn-warning mt-1">
                ...
                <div className="col-lg-4 mb-3">
                    ...
                    <div className="bla">
                            ...
                            <>
                                ...
                                <div>
                                    <p>
                                        ...
                                        <input type="hidden" name="nbrPersonne" value={nbrPersonne}/>

                                        <button type="button" onClick={increment} className="mx-1 btn-reduit">
                                            ▲
                                        </button>
                                        <button type="button" onClick={decrement} className="btn-reduit">
                                            ▼
                                        </button>
                                        <div className="my-2 text-end">
                                            <b className="bla">
                                                Prix : {totalPetitDej} € / jours
                                            </b>
                                        </div>
                                    </p>
                                </div>
                        ...
                        <div className="mt-4">
                            ...
                            <div>
                                <input type="checkbox" id="degustation" name="degustation" disabled={disabledOptionsAssurances}/>
                                <label htmlFor="degustation"> Service de Dégustation</label>
                            </div>
                            <div>
                                <input type="checkbox" id="massage" name="massage" disabled={disabledOptionsAssurances}/>
                                <label htmlFor="massage"> Service de Massage</label>
                            </div>
                            <div>
                                <input type="checkbox" id="chef" name="chef" disabled={disabledOptionsAssurances}/>
                    ...
                    <div className="">
                        ...
                        <div className="bla">
                            ...
                            <div className="input-group mb-3">
                                ...
                                <input type="text" name="nom" className="form-control" placeholder="Entrez votre nom" minLength={2} required={true}/>
                            </div>
                            <div className="input-group mb-3">
                                <div className="input-group-prepend">
                                    <span className="input-group-text" id="inputGroup-sizing-default" required={true}>* Prenom</span>
                                </div>
                                <input type="text" name="prenom" className="form-control" placeholder="Entrez votre prénom" minLength={2} required={true}/>
                            </div>
                            ...
                            <div className="input-group mb-3">
                                ...
                                <input type="mail" name="mail" className="form-control" placeholder="Entrez votre email" required={true}/>
                            </div>
                            ...
                            <div className="input-group mb-3">
                                ...
                                <input type="tel" name="telephone" className="form-control" placeholder="Entrez votre téléphone" minLength={10} required={true}/>
                            </div>

                            <div className="input-group mb-3">
                                <div className="input-group-prepend">
                                    <span className="input-group-text" id="inputGroup-sizing-default">* Commentaires</span>
                                </div>
                                <textarea className="form-control" name="description" rows="3" minLength={10} required={true}></textarea>
                            </div>
                        </div>
                    </div>
                </div>
            ...
            <div className="d-flex justify-content-center mb-3">
                <div className="row">
                    ...
                    {messageGeneral.length > 0 &&
                        <div className="p-3 mb-3 mt-3 text-bg-danger rounded-3">{messageGeneral}</div>
                    }

                    {!isLoaded && <>
                        <button type="submit" className="btn btn-primary">Pré-réserver</button>
                    </>
                    }
                    {isLoaded && <>
                        Veuillez patienter
